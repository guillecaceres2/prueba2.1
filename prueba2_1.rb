def read_alum(file_name)
  ...
  def promedio
    ...
    notas.each do |item_line|
      ...
      puts "El alumno #{item_line[0]} promedio nota: #{acc/cont}"
  ...
  def inasistencias
    ...
    notas.each do |item_line|
      ...
      puts "alumno #{item_line[0]}, #{cont} inasistencias"
  ...
  def aprobación
    ...
    if #{acc/cont} >=5 
      ...
      puts "El alumno #{item_line[0]} aprobó"
    
    else 

      puts "El alumno #{item-line[0]} reprobó"
